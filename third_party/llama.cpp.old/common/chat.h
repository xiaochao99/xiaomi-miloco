...
#include "common.h"
#define MICO_DEFAULT_IMAGE_MARKER "<__image__>"
...
struct common_chat_msg_diff {
    ...
    static std::vector<common_chat_msg_diff> compute_diffs(const common_chat_msg& previous_msg,
...
template <class T>
std::vector<common_chat_msg> common_chat_msgs_parse_oaicompat(const T& messages);
template <class T>
...
// T can be std::string containing JSON or nlohmann::ordered_json
template <class T>
std::vector<common_chat_tool> common_chat_tools_parse_oaicompat(const T& tools);
template <class T>
T common_chat_tools_to_json_oaicompat(const std::vector<common_chat_tool>& tools);

template <class T>
T common_chat_msg_diff_to_json_oaicompat(const common_chat_msg_diff& diff);
